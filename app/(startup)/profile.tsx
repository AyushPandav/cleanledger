...
const styles = StyleSheet.create({
  ...
  role: { fontSize: fontSize.sm, color: colors.black, fontWeight: '600', backgroundColor: colors.grayLight, paddingHorizontal: spacing.md, paddingVertical: spacing.xs, borderRadius: borderRadius.full },
  list: {
    backgroundColor: colors.white,
    borderRadius: borderRadius.lg,
    borderWidth: 1,
